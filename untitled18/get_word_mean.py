...
def main():
    ...
    for i in range(len(key_word)):
        try:
            ...
            file = open("G:\\word_mean_g_p\\"+str(key_word[i])+".txt", 'w', encoding="utf-8")
            file1 = open("G:\\word_phrase_g_p\\"+str(key_word[i])+".txt", 'w', encoding="utf-8")
